! function(e) {
    ...
    function n() {
        var o = e("#" + d.selectors.canvas_seconds).width(),
            s = new Kinetic.Stage({
        ...
        c = new Kinetic.Shape({
            drawFunc: function(o) {
                var s = e("#" + d.selectors.canvas_seconds).width(),
                    t = s / 2 - d.seconds.borderWidth / 2,
                    n = s / 2,
                    a = s / 2;
        ...
        var t = e("#" + d.selectors.canvas_minutes).width(),
            n = new Kinetic.Stage({
        ...
        h = new Kinetic.Shape({
            drawFunc: function(o) {
                var s = e("#" + d.selectors.canvas_minutes).width(),
                    t = s / 2 - d.minutes.borderWidth / 2,
                    n = s / 2,
                    a = s / 2;
        ...
        var a = e("#" + d.selectors.canvas_hours).width(),
            y = new Kinetic.Stage({
        ...
        l = new Kinetic.Shape({
            drawFunc: function(o) {
                var s = e("#" + d.selectors.canvas_hours).width(),
                    t = s / 2 - d.hours.borderWidth / 2,
                    n = s / 2,
                    a = s / 2;
        ...
        var _ = e("#" + d.selectors.canvas_days).width(),
            m = new Kinetic.Stage({
        ...
        u = new Kinetic.Shape({
            drawFunc: function(o) {
                var s = e("#" + d.selectors.canvas_days).width(),
                    t = s / 2 - d.days.borderWidth / 2,
                    n = s / 2,
                    a = s / 2;
